...
class TrainLoop:
    ...
    def sample_some_indices(self, max_indices=20, T=128):
    ...
    def run_loop(self):
        ...
        while (
            ...
            self.step += 1
            print(f'Training at step {self.step}')
    ...
    def forward_backward(self):
        ...
        for i in range(0, batch1.shape[0], self.microbatch):
            ...
            # print(f'loss in forward_backward is {loss}')
            log_loss_dict(
    ...
    def log_samples(self):
        if dist.get_rank() == 0:
            ...
            print(f'samples {samples.shape} latent_mask {latent_mask.shape}, obs_mask {obs_mask.shape}')
...
# We only has one channel
def _mark_as_observed(images, color=[1.]):#color=[1., -1., -1.]
...
def get_blob_logdir(args):
    ...
    print(f'Will save models at: {root_dir}')
