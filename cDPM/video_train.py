...
from improved_diffusion.unet import UNetVideoModel
...
if __name__ == "__main__":
    ...
    # m = UNetVideoModel(in_channels=1, model_channels=128, out_channels=1, num_res_blocks=2, attention_resolutions=[16, 8])
    # outs = m(inputs)
    # print(outs.shape)
